...
import { CursorCliProvider } from "../src/providers/cursor-cli";
...
function parse(file: string): Promise<ConversationMeta | null> {
  return parseMetaWithProvider(new CursorCliProvider(), join(FIXTURES, file), "cursor", TIER);
}
...
describe("CursorCliProvider parsing", () => {
